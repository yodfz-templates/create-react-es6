...
const createLog = require('./devServer/createLog');
const OptionsValidationError = require('./devServer/OptionsValidationError');
const optionsSchema = require('./devServer/optionsSchema.json');
...
Server.addDevServerEntrypoints = require('./devServer/addDevServerEntrypoints');
